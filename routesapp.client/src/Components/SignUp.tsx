                        ...
                        {!submitted ? (
                            <>
                                ...
                                <div className="rp-field">
                                    <label className="rp-label" htmlFor="name">Nombre completo</label>
                            ...
                            <div className="rp-success">
                                ...
                                <h3>¡Bienvenido, {form.name.split(" ")[0]}!</h3>
                                <p>
                                    Tu cuenta ha sido creada. Ahora puedes explorar rutas
                                    personalizadas hechas para ti.
                                </p>
                                <button
